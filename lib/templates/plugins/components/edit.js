...
const components = {
  ...
  // form
  LcHtmlField: () => import('~cms/components/edit/form/LcHtmlField.vue'),
  LcFormContainer: () => import('~cms/components/edit/form/LcFormContainer.vue'),
  ...
  // code mirror
  LcCodeMirror: () => import('~cms/components/edit/form/LcCodeMirror.vue'),
  // media
